...
- .container(하위 요소들을 다 묶고 있는)
  ...
  - .header : width 940px height 110px (총 w가 940을 넘지 않게)

  - .visual : height 120 px

  밑과 같이 선형적인 구조의 디자인을 하려고 한다
  - .main : h auto
    - .g1 w 250px  .g2 w 390px .g3 w 180px , 여백이 30

  - .slogan h auto 위 아래 10px의 여백

  - .footer h auto 위 아래 10px의 여백
...
- content 의 w 100px 인데 boder 5px padding 모두 10px, margin 10px
